...
$ar = document.getElementById("25").innerHTML ="<h3 style=color:blue;> المهارات</h3> <ul>  <li >Java</li> <li >Java FX</li> <li >JavaScript</li> <li >HTML5</li> <li >CSS</li> <li >SQL Server</li> <li >Bootstarp</li>  <li >معرفة بالشبكات.</li> <li >حل المشكلات وتطوير الذات. </li> <li > اجادة اللغة العربية والأنكليزية. </li> </ul> </ul>";
...
$ar = document.getElementById("27").innerHTML ="<spane >نقاط البيع وبرنامج إدارة المطاعم أوميغا سوفت وير(صيانةومبيعات)</spane> <br/>";
