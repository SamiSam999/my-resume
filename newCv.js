...
$ar = document.getElementById("25").innerHTML ="<h3 style=color:blue;> المهارات</h3> <ul>  <li >Java</li> <li >Java FX</li> <li >JavaScript</li> <li >HTML</li> <li >CSS</li> <li >SQL Server</li> <li >Bootstarp</li> <li >معرفة بالشبكات.</li>  <li >حل المشكلات وتطوير الذات. </li> <li > اجادة اللغة العربية والأنكليزية. </li> </ul> </ul>";
...
$ar = document.getElementById("13").innerHTML ="<h3 > الخبرات و المشاريع</h3> ";
 $ar = document.getElementById("20").innerHTML = "<span> أخصائي تقنية معلومات(فحص أمتثال,أدارة النظام)<br/> شركة أبناء محمد الدوسري 02/2020-لتاريخ الحالي <br/>الخبر-المملكة العربية السعودية</span> <br/>";
...
$ar = document.getElementById("19").innerHTML ="<span >موقع الكتروني للسيرتي الذاتية </span><br/><a class="ln" href="https://samisam999.github.io/my-resume/" target="blank" >: موقع السيرة الذاتية</a>";
